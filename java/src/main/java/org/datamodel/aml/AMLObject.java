...
public class AMLObject {
    ...
    /**
     * Constructor for AMLObject with deviceId and timeStamp.
     * 
    ...
    private native long constructAMLObject(String deviceId, String timeStamp) throws AMLException;

    /**
     * Constructor for AMLObject with deviceID, timeStamp and id.
     * 
     * @param       deviceId    [in] Device id that source device of AMLObject.
     * @param       timeStamp   [in] timestamp value of AMLObject delibered by device.
    ...
    /**
     * This function adds AMLData to AMLObject using AMLData key that to match AMLData value.
     * 
    ...
    /**
     * This function returns AMLData which matched input name string with AMLObject's amlDatas key.
     * 
    ...
    /**
     * This function returns string list about AMLObject's amlDatas keys string array.
     * 
    ...
    /**
     * This function returns Device's ID saved on AMLObject.
     * 
    ...
    /**
     * This function returns timestamp that deliveried device.
     * 
    ...
    /**
     * This function returns ID that AMLObject.
     * 
