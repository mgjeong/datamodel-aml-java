...
public class RepresentationTest {
	...
	String amlModelFile                = "./unittests/TEST_DataModel.aml";
    String amlModelFile_invalid_NoCAEX = "./unittests/TEST_DataModel_Invalid_NoCAEX.aml";
    String amlModelFile_invalid_NoSUCL = "./unittests/TEST_DataModel_Invalid_NoSUCL.aml";
    String amlDataFile                 = "./unittests/TEST_Data.aml";
    String dataBinaryFile              = "./unittests/TEST_DataBinary";
